...
public class MessageNotificationServiceImpl implements MessageNotificationService {
     ...
     */
    @Override
    public Long sendWorkNotice(List<String> userIdList) {
    ...
    private String sendChatMessage(String chatId, String accessToken, DingTalkMessage dingTalkMessage) {
        ...
        OapiChatSendRequest.Msg msg = buildDingTalkMessage(dingTalkMessage);
     ...
     * @return
     */
    private OapiChatSendRequest.Msg buildDingTalkMessage(DingTalkMessage dingTalkMessage) {
